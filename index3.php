...
<html xmlns="https://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <style>
      @font-face{
        font-family: 'MGB';
        src: url("/CSS/malgunbd.ttf") format('truetype');
      }
      @font-face{
        font-family: 'NSR';
        src: url("/CSS/NanumSquareRoundR.ttf") format('truetype');
        font-weight: normal;
        font-style: normal;
      }
      @font-face{
        font-family: 'NSR';
        src: url("/CSS/NanumSquareRoundB.ttf") format('truetype');
        font-weight: bold;
        font-style: normal;
      }
      @font-face{
        font-family: 'NSR';
        src: url("/CSS/NanumSquareRoundL.ttf") format('truetype');
        font-weight: lighter;
        font-style: normal;
      }
      .search_bar{
